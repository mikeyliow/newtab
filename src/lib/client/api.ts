...
export const api = {
	...
	addLibrary: (item: object) => call('POST', '/api/library', item),
	updateLibrary: (id: string, patch: object) => call('PATCH', `/api/library/${id}`, patch),
	removeLibrary: (id: string) => call('DELETE', `/api/library/${id}`),
